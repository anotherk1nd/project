...
THIS TRAINS ON THE SIMPLE CORRELATION BETWEEN THE LIMIT ON LAMBDA-R AND THE FAST/SLOW ROTATOR 
BASIS THAT ARE THEREFORE INTRINSICALLY LINKED
"""
...
print data1.field(0) # This returns all the values under the field of column 2
